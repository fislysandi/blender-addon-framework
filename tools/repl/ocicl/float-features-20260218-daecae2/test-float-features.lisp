...
(parachute:define-test negative-bits-to-float
  :compile-at :compile-time
  (parachute:skip-on (ecl abcl clisp) "not implemented"
...
(parachute:define-test short-float-round-trip
  :compile-at :compile-time
  (parachute:skip-on (ecl abcl clasp clisp) "not implemented"
...
(parachute:define-test rounding-modes
  :compile-at :compile-time
  (parachute:skip-on (ecl abcl allegro clasp clisp lispworks) "not implemented"
