...
Defaults to signalling an error on unsupported implementations.")
  ...
  (function fields-short-float
    "Encodes the fields representation into a native short-float

The size of the fields depends on the actual size of the type, as
follows for standard IEEE floating point numbers:

  TYPE | EXPONENT | MANTISSA
    16 |        4 |       10
    32 |        7 |       23 < Almost always this
    64 |       10 |       52
   128 |       14 |      112
   256 |       18 |      236

In order to reliably know the size of the fields at compile-time,
please make use of the bittage feature flags, such as
:16-BIT-SHORT-FLOATS .

See BITS-SHORT-FLOAT")

  (function fields-single-float
    "Encodes the fields representation into a native single-float
...
See BITS-SINGLE-FLOAT")

  (function fields-double-float
    "Encodes the fields representation into a native double-float
...
follows for standard IEEE floating point numbers:
  ...
  TYPE | EXPONENT | MANTISSA
    16 |        4 |       10
    32 |        7 |       23
    64 |       10 |       52  < Almost always this
   128 |       14 |      112
   256 |       18 |      236

In order to reliably know the size of the fields at compile-time,
please make use of the bittage feature flags, such as
:64-BIT-DOUBLE-FLOATS .

See BITS-DOUBLE-FLOAT")

  (function fields-long-float
    "Encodes the fields representation into a native long-float
...
See BITS-LONG-FLOAT")
  ...
  (function short-float-fields
    "Decodes the fields representation from a native short-float.

The fields are returned as multiple values in order of:
  MANTISSA (unsigned-byte)
...
See SHORT-FLOAT-BITS")

  (function single-float-fields
    "Decodes the fields representation from a native single-float.
...
See SINGLE-FLOAT-BITS")

  (function double-float-fields
    "Decodes the fields representation from a native double-float.
...
See DOUBLE-FLOAT-BITS")

  (function long-float-fields
    "Decodes the fields representation from a native long-float.
