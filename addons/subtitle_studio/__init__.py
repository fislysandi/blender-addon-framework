...
Subtitle Editing toolkit for Blender Video Sequence Editor.
...
bl_info = {
    ...
    "author": "Fisly (original by tin2tin)",
    "version": (1, 0, 1),
    "blender": (4, 5, 0),
    "location": "Video Sequence Editor > Sidebar > Subtitle Studio",
    "description": "Subtitle Editing toolkit for Blender VSE. Based on https://github.com/tin2tin/Subtitle_Editor",
    "warning": "",
    "doc_url": "",
    "support": "COMMUNITY",
    "category": "Sequencer",
...
def unregister():
    ...
    # Remove properties before class teardown to avoid stale RNA references.
