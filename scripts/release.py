#!/usr/bin/env python3
"""Release/packaging tool for addons."""
...
def main():
    parser = argparse.ArgumentParser(description="Package a Blender addon")
    parser.add_argument("addon", nargs="?", default=ACTIVE_ADDON, help="Addon name")
    parser.add_argument(
        "--release-dir", default=DEFAULT_RELEASE_DIR, help="Release directory"
    )
    ...
    if not args.addon:
        ...
        print("Usage: uv run release <addon_name>")
        print("\nAvailable addons:")
